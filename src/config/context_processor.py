from config.url_names import (
    PATIENT_CREATE, PATIENT_LIST, PATIENT_DETAIL, PATIENT_UPDATE, PATIENT_DELETE,
    DOCTOR_CREATE, DOCTOR_LIST, DOCTOR_DETAIL, DOCTOR_UPDATE, DOCTOR_DELETE,
    NURSE_CREATE, NURSE_LIST, NURSE_DETAIL, NURSE_UPDATE, NURSE_DELETE
)
